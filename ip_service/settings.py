"""
Django settings for ip_service project.
...
SECRET_KEY = 'django-insecure-#-y%p8af1&^@7dipbyjxu5^33z9n&=e3xg%xe8cdp^l5)5(13f'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'ip_management.authentication.SafeJWTAuthentication',
    ),
